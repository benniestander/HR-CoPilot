...
// Payment processing logic has been replaced by 'requestInvoice' in dbService.ts.

export const processPayment = async (details: any): Promise<{ success: boolean; redirectUrl?: string; error?: string }> => {
