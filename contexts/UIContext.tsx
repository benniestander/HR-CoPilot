...
type View = 'dashboard' | 'generator' | 'updater' | 'checklist' | 'profile' | 'upgrade' | 'topup' | 'knowledge-base' | 'payment-success' | 'transactions' | 'auditor' | 'waitlist' | 'consultants' | 'templates' | 'library' | 'pitch';
