...
const Login: React.FC<LoginProps> = ({ onLogin, onForgotPassword, onShowLanding, onShowPrivacyPolicy, onShowTerms }) => {
    ...
    const handleLoginSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // On success, onAuthStateChanged will unmount this component, so no need to setLoading(false)
        } catch (error) {
            // On failure, the component remains mounted, so stop loading
            setLoading(false);
        }
    };
        ...
        <>
            ...
            <form onSubmit={handleResetSubmit} className="space-y-4">
             ...
             <p className="text-sm text-gray-600 mt-6">
                ...
                <button onClick={() => { setView('login'); setEmailError(''); }} className="font-semibold text-primary hover:underline">
                    Back to Sign In
                </button>
            </p>
        </>
