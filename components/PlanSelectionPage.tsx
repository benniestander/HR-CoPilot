        ...
        <div className="min-h-screen bg-white text-secondary flex flex-col">
            <header className="py-6">
                <div className="container mx-auto flex justify-between items-center px-6">
                    <img src="https://i.postimg.cc/h48FMCNY/edited-image-11-removebg-preview.png" alt="HR Co-Pilot Logo" className="h-12" />
            ...
            <main className="flex-grow container mx-auto flex flex-col items-center px-6 py-12">
                <div className="w-full max-w-2xl">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                        <PlanSelectorCard plan="pro" title="HR Co-Pilot Pro" price="R747 / year" badge="Recommended" />
                    ...
                    <div className="mb-10 text-center">
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                             <h3 className="text-lg font-bold text-primary mb-3">HR Co-Pilot Pro adds:</h3>
                             <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3 max-w-lg mx-auto text-left">
