...
import { CheckIcon, XIcon, GoogleIcon } from './Icons';
    ...
    const PlanSelectorCard: React.FC<{ plan: 'pro' | 'payg', title: string, price: string, badge?: string }> = ({ plan, title, price, badge }) => {
        ...
        return (
            <div
                ...
                className={`relative border-2 rounded-lg p-5 cursor-pointer transition-all duration-200 ${isSelected ? 'border-primary bg-primary/5' : 'border-gray-300 bg-white hover:border-gray-400'
                    }`}
            >
