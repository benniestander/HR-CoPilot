...
// Dynamic imports used instead of static imports for performance
                        ...
                        {updateResult.changes.length > 0 ? (
                            updateResult.changes.map((change, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`border rounded-lg p-6 transition-all duration-200 min-w-0 ${isSelected ? 'border-primary bg-white shadow-md ring-1 ring-primary/20' : 'border-gray-200 bg-gray-50 opacity-80'
                                            }`}
                                    >
